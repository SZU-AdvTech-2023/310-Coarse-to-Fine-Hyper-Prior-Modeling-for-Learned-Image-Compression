...
class analysisTransformModel(nn.Module):
    def __init__(self, in_dim, num_filters, conv_trainable=True):
        ...
        self.transform = nn.Sequential(
            ...
            nn.ZeroPad2d((1, 2, 1, 2)),
            nn.Conv2d(num_filters[0], num_filters[0], 5, 2, 0),
            GDN(num_filters[0]),
            ...
            nn.ZeroPad2d((1, 2, 1, 2)),
            nn.Conv2d(num_filters[1], num_filters[1], 5, 2, 0),
            GDN(num_filters[1]),
...
class synthesisTransformModel(nn.Module):
    def __init__(self, in_dim, num_filters, conv_trainable=True):
        ...
        self.transform = nn.Sequential(
            ...
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.ConvTranspose2d(
                num_filters[0], num_filters[0], 5, 2, 3, output_padding=1),
            IGDN(num_filters[0]),
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.ConvTranspose2d(
            ...
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.ConvTranspose2d(
                num_filters[1], num_filters[1], 5, 2, 3, output_padding=1),
            IGDN(num_filters[1]),
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.ConvTranspose2d(
...
class h_analysisTransformModel(nn.Module):
    def __init__(self, in_dim, num_filters, strides_list, conv_trainable=True):
        ...
        self.transform = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(num_filters[0], num_filters[0], 3, strides_list[0], 1),
            nn.ReLU(),
            Space2Depth(2),
...
class h_synthesisTransformModel(nn.Module):
    def __init__(self, in_dim, num_filters, strides_list, conv_trainable=True):
        ...
        self.transform = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(num_filters[0], num_filters[0], 1, strides_list[2], 0),
            nn.ReLU(),
